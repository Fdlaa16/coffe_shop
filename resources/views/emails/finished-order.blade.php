                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 0 20px 20px 20px; color: #333;">
                            <h2 style="color: #28a745; text-align: center; margin: 0 0 20px 0;">
                            ...
                            <p>Terima kasih telah melakukan pemesanan di <strong>PAPASANS Coffee Shop</strong>.
                                Kami dengan senang hati memberitahukan bahwa pesananmu telah <strong>selesai
                                    diproses</strong> dan siap dinikmati.</p>
                            ...
                            <div style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin: 20px 0;">
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="padding: 8px 0; border-bottom: 1px solid #eee; color: #28a745; font-weight: bold;">
                                            Selesai
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <ul style="color: #555; line-height: 1.6;">
                                <li>Pesanan kamu segera diantar, mohon menunggu sebentar.</li>
                            </ul>

                            <p style="color: #555; font-size: 14px;">Jika ada pertanyaan terkait pesananmu, silakan
                                hubungi tim
                                kami melalui email ini atau nomor telepon di website.</p>
