...
const props = defineProps<{ data: FoodData }>()
const emit = defineEmits(['submit', 'update:data'])

const localData = ref<FoodData>({
  ...props.data,
})
