...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dashboards-customer-add': RouteRecordInfo<'dashboards-customer-add', '/dashboards/customer/add', Record<never, never>, Record<never, never>>,
    'dashboards-customer-edit-id': RouteRecordInfo<'dashboards-customer-edit-id', '/dashboards/customer/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-customer-list': RouteRecordInfo<'dashboards-customer-list', '/dashboards/customer/list', Record<never, never>, Record<never, never>>,
    'dashboards-ecommerce': RouteRecordInfo<'dashboards-ecommerce', '/dashboards/ecommerce', Record<never, never>, Record<never, never>>,
    'dashboards-invoice-add': RouteRecordInfo<'dashboards-invoice-add', '/dashboards/invoice/add', Record<never, never>, Record<never, never>>,
    'dashboards-invoice-edit-id': RouteRecordInfo<'dashboards-invoice-edit-id', '/dashboards/invoice/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-invoice-list': RouteRecordInfo<'dashboards-invoice-list', '/dashboards/invoice/list', Record<never, never>, Record<never, never>>,
    'dashboards-menu-add': RouteRecordInfo<'dashboards-menu-add', '/dashboards/menu/add', Record<never, never>, Record<never, never>>,
    'dashboards-menu-edit-id': RouteRecordInfo<'dashboards-menu-edit-id', '/dashboards/menu/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-menu-list': RouteRecordInfo<'dashboards-menu-list', '/dashboards/menu/list', Record<never, never>, Record<never, never>>,
    'dashboards-order-edit-id': RouteRecordInfo<'dashboards-order-edit-id', '/dashboards/order/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-order-list': RouteRecordInfo<'dashboards-order-list', '/dashboards/order/list', Record<never, never>, Record<never, never>>,
    'dashboards-profile': RouteRecordInfo<'dashboards-profile', '/dashboards/profile', Record<never, never>, Record<never, never>>,
    'dashboards-table-add': RouteRecordInfo<'dashboards-table-add', '/dashboards/table/add', Record<never, never>, Record<never, never>>,
    'dashboards-table-edit-id': RouteRecordInfo<'dashboards-table-edit-id', '/dashboards/table/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-table-list': RouteRecordInfo<'dashboards-table-list', '/dashboards/table/list', Record<never, never>, Record<never, never>>,
    ...
    'landing-page-id-table': RouteRecordInfo<'landing-page-id-table', '/landing-page/:id/table', { id: ParamValue<true> }, { id: ParamValue<false> }>,
