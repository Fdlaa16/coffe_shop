...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dashboards-drink-add': RouteRecordInfo<'dashboards-drink-add', '/dashboards/drink/add', Record<never, never>, Record<never, never>>,
    'dashboards-drink-edit-id': RouteRecordInfo<'dashboards-drink-edit-id', '/dashboards/drink/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-drink-list': RouteRecordInfo<'dashboards-drink-list', '/dashboards/drink/list', Record<never, never>, Record<never, never>>,
    'dashboards-ecommerce': RouteRecordInfo<'dashboards-ecommerce', '/dashboards/ecommerce', Record<never, never>, Record<never, never>>,
    'dashboards-food-add': RouteRecordInfo<'dashboards-food-add', '/dashboards/food/add', Record<never, never>, Record<never, never>>,
    'dashboards-food-edit-id': RouteRecordInfo<'dashboards-food-edit-id', '/dashboards/food/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dashboards-food-list': RouteRecordInfo<'dashboards-food-list', '/dashboards/food/list', Record<never, never>, Record<never, never>>,
